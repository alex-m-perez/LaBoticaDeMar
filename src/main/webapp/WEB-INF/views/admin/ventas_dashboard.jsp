<div class="bg-white min-h-screen space-y-6">
	...
	<div class="grid grid-cols-1 md:grid-cols-4 gap-4">
		<div class="p-4 rounded-2xl shadow border">
			...
			<p class="text-2xl font-bold">419,12 €</p>
		</div>
		<div class="p-4 rounded-2xl shadow border">
		...
		<div class="p-4 rounded-2xl shadow border">
			...
			<p class="text-2xl font-bold">7,82 €</p>
		</div>
		<div class="p-4 rounded-2xl shadow border">
			...
			<table class="min-w-full text-sm">
				...
				<tbody class="text-gray-700 divide-y">
					<tr>
						...
						<td class="px-4 py-2">SMILEAT TARRITO DE VERDURAS CON LUBINA Y MERLUZA</td>
						<td class="px-4 py-2">3</td>
						<td class="px-4 py-2">8,85 €</td>
					...
					<tr>
						...
						<td class="px-4 py-2">SMILITOS</td>
                    ...
                    <tr>
                        <td class="px-4 py-2">#00127</td>
                        <td class="px-4 py-2">11/04/2025</td>
                        <td class="px-4 py-2">TIJERAS DE INICIACION SARO</td>
                        <td class="px-4 py-2">2</td>
                        <td class="px-4 py-2">14,75 €</td>
                        <td class="px-4 py-2">Online</td>
                        <td class="px-4 py-2">Laura M.</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-2">#00128</td>
                        <td class="px-4 py-2">12/06/2025</td>
                        <td class="px-4 py-2">SMILEAT TARRITO DE VERDURAS CON LUBINA Y MERLUZA</td>
                        <td class="px-4 py-2">5</td>
