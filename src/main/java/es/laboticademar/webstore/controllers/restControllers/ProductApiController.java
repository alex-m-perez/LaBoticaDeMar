...
public class ProductApiController {
    ...
    @PostMapping("/upload")
    public ResponseEntity<Void> uploadProducts(@RequestParam("file") MultipartFile file) throws Exception {
        List<Producto> duplicados = productService.bulkUpload(file);
